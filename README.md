...
```
now_utc : UTC time generated by the Linux MPU (ISO-8601 format).  
The browser converts this UTC timestamp to the local time of the user before displaying it in the dashboard.
